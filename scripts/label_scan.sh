...
NOISE='f32|f64|sha256|\b[0-9a-fA-F]{8,}\b|0x[0-9a-fA-F]+|#[0-9A-Fa-f]{6}|U\+?[0-9A-F]{4,}|F401|FF6405|ff6405|RingOf|_mm256|package-lock|0B0F19'

# This script quotes the labels it hunts for, so it must exclude itself.
TREES='src include tests web/src api scripts deploy db sql-extensions
       cortrix-mcp cortrix-skills cortrix-agent :!scripts/label_scan.sh'
