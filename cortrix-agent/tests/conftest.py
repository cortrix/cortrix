...
# Make the sibling P03 Python SDK importable (cortrix/sdk/python), mirroring main.py —
# the agent dogfoods the SDK rather than pip-installing it (design P-12 / section 5.2).
