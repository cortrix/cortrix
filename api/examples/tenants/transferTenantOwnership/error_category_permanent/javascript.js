// POST /api/v1/tenants/{tenant_id}/transfer-ownership — error (HTTP 404)
const resp = await fetch("https://api.cortrix.io/api/v1/tenants/{tenant_id}/transfer-ownership", {
  method: "POST",
