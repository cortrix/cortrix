-- Metadata Block — metadata_blocks table (detailed design, lock: separate table).
--
...
-- + V2 remediation, incl. custom_metadata + meta.parse_status + meta.parse_failed_page).
--
-- FK reconciliation (integration deferred): detailed design declares
