-- F08 Metadata Block — metadata_blocks table (detailed design §3.3, D5 lock: separate table).
--
...
-- but the per-Unit documents.doc_id is INTEGER while F08's doc_id is the TEXT ULID
