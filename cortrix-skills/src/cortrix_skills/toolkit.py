...
Error codes are passed through from the Python SDK (feature design section 7): the Skill
...
class CortrixToolKit:
    ...
    def cortrix_batch_submit(
        ...
        """Submit up to 100 documents to a namespace in one batch (batch submit).
