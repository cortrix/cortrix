...
# The 29 method names, in P12 tool order. Adapters iterate this list (rather than
...
class CortrixToolKit:
    ...
    # =========================================================================
    # MEM03 reverse +4 (#26-29) — Memory Transparency CRUD
    # =========================================================================
    ...
    def cortrix_memory_invalidate(
        ...
        Pass-through GEN-Agent 4-field error response.
        """
        # The P03 SDK invalidate(==delete) takes only memory_id; namespace / reason
        # are P12-wire query params, so when supplied we use the HTTP fallback to
        # preserve the full P12 contract (no P03 SDK change).
