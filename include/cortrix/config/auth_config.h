...
/// Runtime Auth configuration (P08 §2.14 / §2.12 — topic 8 minimal IGlobalConfig).
///
...
/// (common/i_global_config.h, F12 §3.8). S1 ships the POD snapshot + the table
...
/// Number of default keys written on first start (P08 §3.6 default key set = 12;
