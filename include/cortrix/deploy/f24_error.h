...
///
/// Same convention as catalog_error.h / f42_error.h (CODING_CONVENTIONS §3):
...
/// identified by its CX_ERR_* code. So F24ErrorCode is the *enum of identities*,
/// and MakeF24Error() turns one (plus optional structured_data) into that boundary
...
/// The "CX_ERR_*" string for `code` (convenience over GetF24ErrorInfo).
