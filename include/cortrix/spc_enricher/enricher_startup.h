...
/// Result of the enricher startup validation (design §4.1). Drives the §4.4
...
/// Run the startup validation for `config` against `transport` (topic 3.6 §4.1):
///   type != llm                         → kNullType
...
/// bootstrap (live endpoint, HTTPS) is D3.5 deferred wiring.
