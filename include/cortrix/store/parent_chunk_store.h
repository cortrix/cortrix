...
// F34 ParentChunkStore — parents-table data-access layer (Repository pattern,
// detailed design § 2.5 / § 2.5.1, D1 V3 ruling 2).
//
// Single-point + batch lookup of parent_text for downstream Enrichers reverse-
// looking-up context: F38 HyPEEnricher (§ 6.3 GetParent), F41 doc-summary /
// ExpandParentText (§ 8.1 BulkGetParents). Dependency-injected + mock-friendly so
// those features unit-test against this interface (parallel to F02's ChunkStore,
...
public:
    ...
    /// Single-point lookup (F38 HyPEEnricher § 6.3). Returns:
    ///   Ok(ParentChunk)                      — hit
    ...
    /// Batch lookup (F41 ExpandParentText top-K / F38 post-RRF batch reverse-
