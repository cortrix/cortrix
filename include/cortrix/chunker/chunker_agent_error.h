...
// turning one into the GEN-Agent boundary body. Per the coding conventions the
...
/// The 3 hard chunker error identities (blocking). The 2 warnings
...
/// Canonical, immutable attributes of one error code (columns).
...
// --- Non-blocking warnings (rows 4-5 / meta.warnings) ---------------
...
/// boundary appends these to meta.warnings. category is implicitly
