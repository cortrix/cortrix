...
///        silently-degraded chunks (enrich ⇔ enriched_score, contextual ⇔
///        contextualized_status==1, hype ⇔ a hype block with this source child);
...
/// ("enrich"/"contextual"/"hype") — the owed universe for the audit; empty ⇒ the endpoint
