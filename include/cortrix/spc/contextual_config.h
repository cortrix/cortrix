...
// IGlobalConfig scaffolding header (an contextual-typed getter would be a integration reverse
...
/// 10s default assumed sub-10s provider latency; large prompts on a
...
/// IGlobalConfig key: injection-guard chars-per-token multiplier. The guard
...
/// vector silently dropped (deep-QA finding 2026-07-10; live 5k evidence
...
/// resilience layer at integration).
