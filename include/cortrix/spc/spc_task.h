...
#include "cortrix/spc/cleaning_types.h"  // CleaningResult (the 4 A-class fields)
...
struct SPCTask {
    ...
    // path stats (hash/semantic split, by_reason) go to the operation_log.
    ...
    /// chunks_marked_anomalous), per the data-cleaning contract.
