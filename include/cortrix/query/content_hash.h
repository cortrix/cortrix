...
/// content_hash representation helpers for cross-NS dedup (the retrieval-types spec
...
/// **integration**. Standalone, SingleUnitExecutor derives the hash directly from the
...
/// 16-byte raw (hi, lo) → "sha256:<32-hex>" (the retrieval-types spec,
