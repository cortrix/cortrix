...
/// RagFusionStage — the F36 multi-query expansion + global RRF orchestration over
/// the F04 ScatterGather (Q5 wiring).
///
/// Activation (F36 §4.3 + Q5 brief): runs ONLY when the F39 route is "complex" AND
...
/// CrossNsResponse to the F36 ScoredResult[] (child_id + score); global RRF
