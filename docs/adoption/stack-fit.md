...
| Tested identity | Canonical benchmark bundle commit `7bc29aa840c20db3935dfcf80eb048e553ebe2b0`; Core `4a6299ca86c7bec21ed7b8989a729a198fe5a42a`; profile `bge_m3_rerank_baseline_v2`; full-corpus SciFact, FiQA, and NFCorpus measurements. |
...
| Evidence | [Pinned profile](https://github.com/cortrix/cortrix-benchmarks/blob/7bc29aa840c20db3935dfcf80eb048e553ebe2b0/results/published/beir-three-full-corpus-2026-07-v1/profiles/embedding-reranking.json) and [pinned bundle manifest](https://github.com/cortrix/cortrix-benchmarks/blob/7bc29aa840c20db3935dfcf80eb048e553ebe2b0/results/published/beir-three-full-corpus-2026-07-v1/manifest.json). |

Measurement boundary: the referenced bundle measures retrieval quality only. It does not establish end-to-end answer quality, universal domain performance, production latency, business outcomes, or compatibility with a named external vector database.
