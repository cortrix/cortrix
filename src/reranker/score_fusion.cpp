...
float RerankerScoreFusion::ComputeRerankRrfScore(
    ...
    // Base fusion: weighted_sum of the cross-encoder precision score and the
    // RRF recall score. When enriched/semantic score signals are present, delegate the
    // semantic multiplier to the existing semantic-score policy.
