...
Status HypeSchemaProvider::Migrate(sqlite3* /*db*/, int from_ver, int to_ver) {
    ...
    // defensively (mirrors RerankerSchemaProvider).
    ...
    return Status::InvalidArgument(
        "CX_ERR_HYPE_SCHEMA_VERSION_MISMATCH: hype unsupported migration " +
