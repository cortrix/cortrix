...
TEST_F(TaskLifecycleTest, SubmitProcessCompleteViaPolling) {
...
TEST_F(TaskLifecycleTest, CancelMidProcessingStopsAtCheckpoint) {
    std::string task_id;
...
TEST_F(TaskLifecycleTest, ZombieSweptByCronThenVisibleViaProgress) {
...
TEST_F(TaskLifecycleTest, WatcherDebounceMergeThroughHandler) {
