/// @file test_agent_trace_observability_e2e.cpp
...
class AgentTraceObservabilityE2E : public ::testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(AgentTraceObservabilityE2E, OwnerReadsOwnSessionTraces) {
  auto c = h_->Client();
...
TEST_F(AgentTraceObservabilityE2E, NonOwnerNonAdminDeniedTraces) {
  auto c = h_->Client();
...
TEST_F(AgentTraceObservabilityE2E, TracesRequireAuth) {
  auto c = h_->Client();
...
TEST_F(AgentTraceObservabilityE2E, TracesStatusFilterApplies) {
  auto c = h_->Client();
...
TEST_F(AgentTraceObservabilityE2E, ListInteractionsPerNamespace) {
  auto c = h_->Client();
...
TEST_F(AgentTraceObservabilityE2E, ListInteractionsRequiresNamespace) {
  auto c = h_->Client();
...
TEST_F(AgentTraceObservabilityE2E, OperationsSelfScope) {
  auto c = h_->Client();
...
TEST_F(AgentTraceObservabilityE2E, OperationsCrossUserDenied) {
  auto c = h_->Client();
