...
class Mem05SearchIsolation : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(Mem05SearchIsolation, UserAOnlySeesOwnMemory) {
...
TEST_F(Mem05SearchIsolation, UserBOnlySeesOwnMemory) {
...
TEST_F(Mem05SearchIsolation, UnknownUserSeesNothing) {
...
class Mem05StoreIsolation : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(Mem05StoreIsolation, ListOnlyReturnsOwnSessions) {
...
TEST_F(Mem05StoreIsolation, SessionGetCrossUser_DeniedByOwnership) {
...
TEST_F(Mem05StoreIsolation, EditCrossUser_DeniedByOwnership) {
    std::string a_sid = CreateSession("user_A");
...
TEST_F(Mem05StoreIsolation, DeleteCrossUser_DeniedByOwnership) {
    std::string a_sid = CreateSession("user_A");
...
TEST_F(Mem05StoreIsolation, DefaultUser_RoundTrips) {
...
TEST_F(Mem05StoreIsolation, InteractionSearchUserFilter) {
    std::string a_sid = CreateSession("user_A");
