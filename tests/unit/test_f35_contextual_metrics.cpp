...
class F35ContextualMetricsTest : public ::testing::Test {
protected:
...
TEST_F(F35ContextualMetricsTest, ChunksTotalCountsPerStatus) {
...
TEST_F(F35ContextualMetricsTest, LlmCostTokensPerModel) {
...
TEST_F(F35ContextualMetricsTest, FallbackRatioGaugeClamps) {
...
TEST_F(F35ContextualMetricsTest, QueryViaPathCountsPerPath) {
...
TEST_F(F35ContextualMetricsTest, StatusLabelStrings) {
...
TEST_F(F35ContextualMetricsTest, PathLabelStrings) {
...
TEST_F(F35ContextualMetricsTest, RenderOpenMetricsContainsAllSeries) {
    m().RecordChunk(ChunkStatus::kGenerated);
...
TEST_F(F35ContextualMetricsTest, RenderHasNoHighCardinalityLabels) {
...
TEST_F(F35ContextualMetricsTest, ResetClearsEverything) {
    m().RecordChunk(ChunkStatus::kGenerated);
    m().AddLlmCostTokens("gpt-4o-mini", 80);
