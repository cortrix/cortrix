...
TEST(DocSummaryErrorTest, CountIsSeven) {
    EXPECT_EQ(kDocSummaryErrorCodeCount, 7);
    EXPECT_EQ(std::size(kAll), 7u);
}

TEST(DocSummaryErrorTest, CodeStringsMatchDesign) {
...
TEST(DocSummaryErrorTest, AllCodesUniqueAndPrefixed) {
...
TEST(DocSummaryErrorTest, CategoryAndRetryMatchDesign) {
...
TEST(DocSummaryErrorTest, RetryableImpliesRetryAfterSet) {
    for (auto code : kAll) {
...
TEST(DocSummaryErrorTest, RequiredStructuredDataKeys) {
...
TEST(DocSummaryErrorTest, HasRequiredStructuredData) {
...
TEST(DocSummaryErrorTest, MakeErrorFillsFromRegistry) {
...
TEST(DocSummaryErrorTest, MakeErrorSerializesToAgentFriendlyBody) {
...
TEST(DocSummaryErrorTest, StatusCodeMapping) {
