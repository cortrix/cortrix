...
class MemoryIsolationTest : public ::testing::Test {
protected:
...
TEST_F(MemoryIsolationTest, Validate_UserIdPresent_Succeeds) {
    auto r = BaseReq();
    r.scope = MemoryScope::kUser;
    r.user_id = "u1";
...
TEST_F(MemoryIsolationTest, Validate_SessionScope_UserIdRequired) {
    auto r = BaseReq();
...
TEST_F(MemoryIsolationTest, Validate_SessionScope_WithUserId_Succeeds) {
    auto r = BaseReq();
    r.scope = MemoryScope::kSession;
    r.user_id = "u1";
    r.session_id = "s1";
...
TEST_F(MemoryIsolationTest, UserIdFormat_TooLong_Rejected) {
    auto r = BaseReq();
...
TEST_F(MemoryIsolationTest, UserIdFormat_ValidChars_Accepted) {
    auto r = BaseReq();
...
TEST_F(MemoryIsolationTest, UserIdFormat_Boundary128_Accepted) {
    auto r = BaseReq();
    r.user_id = std::string(128, 'x');
    EXPECT_TRUE(r.Validate().ok());
}

TEST_F(MemoryIsolationTest, UserIdFormat_NonAscii_Rejected) {
    auto r = BaseReq();
...
TEST_F(MemoryIsolationTest, MatchScope_UserIdMatch_Included) {
    auto r = BaseReq();
    r.scope = MemoryScope::kUser;
    r.user_id = "u1";
    json meta;
...
TEST_F(MemoryIsolationTest, MatchScope_NoUserIdInMetadata_Excluded) {
    auto r = BaseReq();
    r.scope = MemoryScope::kUser;
    r.user_id = "u1";
    json meta;
...
TEST_F(MemoryIsolationTest, MatchScope_EmptyUserIdInMetadata_Excluded) {
    auto r = BaseReq();
    r.scope = MemoryScope::kUser;
    r.user_id = "u1";
    json meta;
...
TEST_F(MemoryIsolationTest, MatchScope_SessionScope_WrongUser_Excluded) {
    auto r = BaseReq();
    r.scope = MemoryScope::kSession;
    r.user_id = "u1";
    r.session_id = "s1";
...
TEST_F(MemoryIsolationTest, MatchScope_SessionScope_RightUser_RightSession) {
    auto r = BaseReq();
    r.scope = MemoryScope::kSession;
    r.user_id = "u1";
    r.session_id = "s1";
...
TEST_F(MemoryIsolationTest, MatchScope_SessionScope_RightUser_WrongSession) {
    auto r = BaseReq();
    r.scope = MemoryScope::kSession;
    r.user_id = "u1";
    r.session_id = "s1";
...
TEST_F(MemoryIsolationTest, MatchScope_NullMetadata_Excluded) {
    auto r = BaseReq();
    r.scope = MemoryScope::kUser;
    r.user_id = "u1";
...
TEST_F(MemoryIsolationTest, MatchScope_UserIdNotString_Excluded) {
    auto r = BaseReq();
    r.scope = MemoryScope::kUser;
    r.user_id = "u1";
    json meta;
