...
// Exhaustive parameterized error-registry sweep for F35 contextual retrieval (§8,
// 5 codes). Distinct suite (ContextualErrorMatrix) from test_f35_contextual_error.cpp.
