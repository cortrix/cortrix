...
using ExtractStatus = Mem02Metrics::ExtractStatus;
using TokenDirection = Mem02Metrics::TokenDirection;
using ConfidenceBucket = Mem02Metrics::ConfidenceBucket;
using TriggeredBy = Mem02Metrics::TriggeredBy;

class Mem02MetricsTest : public ::testing::Test {
protected:
...
TEST_F(Mem02MetricsTest, ExtractTotalCountsByStatus) {
...
TEST_F(Mem02MetricsTest, TokensSummedByDirectionAcrossModels) {
...
TEST_F(Mem02MetricsTest, QueueDepthGaugeSetAndClamped) {
    M().SetQueueDepth(7);
...
TEST_F(Mem02MetricsTest, ContradictionBucketing) {
    EXPECT_EQ(Mem02Metrics::BucketForConfidence(0.95), ConfidenceBucket::kHigh);
    EXPECT_EQ(Mem02Metrics::BucketForConfidence(0.6), ConfidenceBucket::kMedium);
    EXPECT_EQ(Mem02Metrics::BucketForConfidence(0.2), ConfidenceBucket::kLow);
    EXPECT_EQ(Mem02Metrics::BucketForConfidence(0.8), ConfidenceBucket::kHigh);   // boundary
    EXPECT_EQ(Mem02Metrics::BucketForConfidence(0.5), ConfidenceBucket::kMedium); // boundary
...
TEST_F(Mem02MetricsTest, InvalidationsByTrigger) {
...
TEST_F(Mem02MetricsTest, RenderOpenMetricsHasAllSixMetricsAndTypes) {
    M().RecordExtract(ExtractStatus::kSuccess);
...
TEST_F(Mem02MetricsTest, ExtractDurationHistogramBucketsAreCumulativeAndComplete) {
...
TEST_F(Mem02MetricsTest, RenderHasNoHighCardinalityLabels) {
...
TEST_F(Mem02MetricsTest, ModelOverflowFoldsIntoOtherBucket) {
...
TEST_F(Mem02MetricsTest, LabelStringsMatchSpec) {
