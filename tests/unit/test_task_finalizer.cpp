// TaskFinalizer (F42 §4.1.1, finalize ownership = handler · decision A): the shared
// terminal-write + F42 task-metric collapse used by DocumentProcessor / F41AsyncWorker.
