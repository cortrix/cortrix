...
TEST(F38HypeFusionTest, ChunkOnlyRrf) {
...
TEST(F38HypeFusionTest, HypeMapsToSourceChild) {
...
TEST(F38HypeFusionTest, ChunkAndHypeSameChildAccumulates) {
...
TEST(F38HypeFusionTest, HypeBoostsRankAboveChunkOnly) {
...
TEST(F38HypeFusionTest, BestHypeQuestionWins) {
...
TEST(F38HypeFusionTest, ByParentDedupKeepsHighest) {
...
TEST(F38HypeFusionTest, DifferentParentsBothKept) {
    std::vector<HypeCandidate> pool = {Chunk("c1", 0.9f), Chunk("c2", 0.5f)};
...
TEST(F38HypeFusionTest, UnknownParentIsOwnGroup) {
    std::vector<HypeCandidate> pool = {Chunk("c1", 0.9f), Chunk("c2", 0.5f)};
...
TEST(F38HypeFusionTest, TopNTruncates) {
    std::vector<HypeCandidate> pool = {Chunk("a", 0.9f), Chunk("b", 0.5f),
                                       Chunk("c", 0.3f)};
...
TEST(F38HypeFusionTest, EmptyPoolEmptyOut) {
    EXPECT_TRUE(FuseHypeRecall({}, {}).empty());
}

TEST(F38HypeFusionTest, RrfKZeroGuarded) {
