...
TEST(RouterHeuristicBackendTest, Identity) {
    HeuristicComplexityBackend b;
    EXPECT_EQ(b.Name(), "heuristic_guard");
    EXPECT_TRUE(b.IsAvailable());
}

TEST(RouterHeuristicBackendTest, ShortQueryIsSimple) {
    HeuristicComplexityBackend b;
...
TEST(RouterHeuristicBackendTest, ComparisonCueIsComplex) {
    HeuristicComplexityBackend b;
...
TEST(RouterHeuristicBackendTest, LongQueryIsComplex) {
    HeuristicComplexityBackend b;
...
TEST(RouterHeuristicBackendTest, EmptyQueryIsChatSafetyNet) {
    HeuristicComplexityBackend b;
    EXPECT_EQ(b.Infer("").label, "chat");
    EXPECT_EQ(b.Infer("   ").label, "chat");
}

TEST(RouterHeuristicBackendTest, ChineseComparisonCueIsComplex) {
    HeuristicComplexityBackend b;
...
TEST(RouterHeuristicBackendTest, ReportedConfidenceConfigurable) {
...
TEST(RouterComplexityConfigTest, ThresholdValidationBounds) {
    ComplexityConfig c;
...
TEST(RouterComplexityConfigTest, ForceRouteValidation) {
    ComplexityConfig c;
