...
TEST(F35ContextualErrorTest, CountIsFive) {
...
TEST(F35ContextualErrorTest, CategoryAndRetryMatchDesign) {
...
TEST(F35ContextualErrorTest, RetryableImpliesRetryAfterSet) {
    for (auto code : kAll) {
...
TEST(F35ContextualErrorTest, RequiredStructuredDataKeys) {
...
TEST(F35ContextualErrorTest, RequiredStructuredDataKeysEmbeddingAndStartup) {
...
TEST(F35ContextualErrorTest, HasRequiredStructuredData) {
...
TEST(F35ContextualErrorTest, HasRequiredStructuredDataNonObjectIsFalse) {
...
TEST(F35ContextualErrorTest, MakeContextualErrorSerializesToAgentFriendlyBody) {
...
TEST(F35ContextualErrorTest, StatusCodeMapping) {
