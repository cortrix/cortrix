...
TEST(SparseEmbedWithSparseTest, NullResultRejected) {
    OnnxEmbedder e("", 128);
    e.Init();
...
TEST(SparseEmbedWithSparseTest, BatchNullResultsRejected) {
    OnnxEmbedder e("", 128);
    e.Init();
...
TEST(SparseEmbedWithSparseTest, NotInitializedFails) {
...
TEST(SparseEmbedWithSparseTest, ProducesDenseAndSparse) {
    OnnxEmbedder e("", 128);
...
TEST(SparseEmbedWithSparseTest, DenseIsUnitNormalized) {
    OnnxEmbedder e("", 256);
    ASSERT_TRUE(e.Init().ok());
...
TEST(SparseEmbedWithSparseTest, SparseWeightsStrictlyPositive) {
    OnnxEmbedder e("", 64);
    ASSERT_TRUE(e.Init().ok());
...
TEST(SparseEmbedWithSparseTest, DeterministicForSameInput) {
    OnnxEmbedder e("", 64);
    ASSERT_TRUE(e.Init().ok());
...
TEST(SparseEmbedWithSparseTest, DifferentInputsDifferentSparse) {
    OnnxEmbedder e("", 64);
    ASSERT_TRUE(e.Init().ok());
...
TEST(SparseEmbedWithSparseTest, EmptyTextEmptySparse) {
    OnnxEmbedder e("", 64);
    ASSERT_TRUE(e.Init().ok());
...
TEST(SparseEmbedWithSparseTest, WhitespaceOnlyEmptySparse) {
    OnnxEmbedder e("", 64);
    ASSERT_TRUE(e.Init().ok());
...
TEST(SparseEmbedWithSparseTest, TopKTruncates) {
    OnnxEmbedder e("", 64);
    ASSERT_TRUE(e.Init().ok());
...
TEST(SparseEmbedWithSparseTest, TopKKeepsHighestWeights) {
    OnnxEmbedder e("", 64);
    ASSERT_TRUE(e.Init().ok());
...
TEST(SparseEmbedWithSparseTest, TopKZeroKeepsAll) {
    OnnxEmbedder e("", 64);
    ASSERT_TRUE(e.Init().ok());
...
TEST(SparseEmbedWithSparseTest, DuplicateTokensAccumulateWeight) {
    OnnxEmbedder e("", 64);
    ASSERT_TRUE(e.Init().ok());
...
TEST(SparseEmbedWithSparseTest, BatchProducesPerItem) {
    OnnxEmbedder e("", 64);
    ASSERT_TRUE(e.Init().ok());
...
TEST(SparseEmbedWithSparseTest, BatchEmptyList) {
    OnnxEmbedder e("", 64);
    ASSERT_TRUE(e.Init().ok());
...
TEST(SparseEmbedWithSparseTest, BatchMatchesSingle) {
    OnnxEmbedder e("", 64);
    ASSERT_TRUE(e.Init().ok());
