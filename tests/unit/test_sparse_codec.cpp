...
TEST(SparseCodecTest, SerializedSize) {
...
TEST(SparseCodecTest, RoundTripBasic) {
...
TEST(SparseCodecTest, RoundTripPreservesFloatBits) {
...
TEST(SparseCodecTest, RoundTripBoundaryTermIds) {
...
TEST(SparseCodecTest, EmptyVectorRoundTrip) {
    bool ok = false;
...
TEST(SparseCodecTest, RawPointerOverload) {
...
TEST(SparseCodecTest, TruncatedHeaderRejected) {
...
TEST(SparseCodecTest, TruncatedBodyRejected) {
...
TEST(SparseCodecTest, TermIdOutOfUint16RangeRejected) {
...
TEST(SparseCodecTest, FlagBitValueIsBit4) {
...
TEST(SparseCodecTest, NonEmptySparseSetsFlagEmptyClears) {
...
TEST(SparseCodecTest, SparseFlagDoesNotDisturbOtherExtBits) {
