...
Response types are plain ``@dataclass`` objects (Python SDK design). The server
JSON may carry extra fields (forward compat, the Agent-friendly contract principle 7) or omit
